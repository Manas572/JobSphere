...
const Hero = () => {
  return (
    <section className="pb-32 md:pb-44 bg-slate-950 text-slate-200 text-sm">
      <div className="flex flex-col-reverse gap-10 md:flex-row px-4 md:px-16 lg:px-24 xl:px-32 pt-12 md:pt-32">
        <div className="max-md:text-center">
          <h5 className="text-4xl md:text-6xl/[76px] font-semibold max-w-xl bg-gradient-to-r from-white to-indigo-400 text-transparent bg-clip-text">
            Build Skills That Get You Hired
          </h5>

          <p className="text-sm md:text-base max-w-lg mt-6 max-md:px-2 text-slate-400">
          ...
          <div className="flex items-center gap-4 mt-6 max-md:justify-center">
            <button
              className="px-8 py-3 rounded-md bg-indigo-600 hover:bg-indigo-500 text-white active:scale-95 transition-all"
              type="button"
            >
              Get Started
            </button>
            <button
              className="px-5 py-3 rounded-md bg-transparent text-indigo-400 border border-indigo-500 flex items-center gap-2 hover:bg-indigo-500/10 active:scale-95 transition-all"
              type="button"
            >
              <svg
                width="16"
          ...
          <div className="flex items-center mt-9 max-md:justify-center">
            <div className="flex -space-x-3.5 pr-3">
              <img
                ...
                alt="user"
                className="size-10 border-2 border-slate-950 rounded-full hover:-translate-y-px transition z-1"
              />
              <img
                src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=200"
                alt="user"
                className="size-10 border-2 border-slate-950 rounded-full hover:-translate-y-px transition z-[2]"
              />
              <img
                src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=200&h=200&auto=format&fit=crop"
                alt="user"
                className="size-10 border-2 border-slate-950 rounded-full hover:-translate-y-px transition z-[3]"
              />
              <img
                src="https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=200&auto=format&fit=crop&q=60"
                alt="user"
                className="size-10 border-2 border-slate-950 rounded-full hover:-translate-y-px transition z-[4]"
              />
              <img
                src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=200&auto=format&fit=crop&q=60"
                alt="user"
                className="size-10 border-2 border-slate-950 rounded-full hover:-translate-y-px transition z-[5]"
              />
            </div>
            <div>
              ...
              <p className="text-sm text-slate-400">Used by 1,000+ people</p>
            </div>
          </div>
        </div>
        <div className="w-full md:max-w-xs lg:max-w-lg">
          {/* Note: Ensure this image looks good on a dark background. You may want to swap this out for a dark-mode variant if you have one. */}
          <img
